...
class MyFinalScene extends MyScene {
    ...
    buildFinalMenu() {
        ...
        this.winnerBalloon = new MyBalloon(this.app, 'WinnerBalloon', winnerData.balloonColor, false);
        ...
        this.loserBalloon = new MyBalloon(this.app, 'LoserBalloon', loserData.balloonColor, false);
